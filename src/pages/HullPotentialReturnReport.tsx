...
const HullPotentialReturnReport = () => {
  const [tableData, setTableData] = useState([
    // Sample data based on the HTML table structure
    {
      id: 1,
      makeOfICCP: 'Marine Protection Systems ICCP-2000',
      dateLastUndocked: '02/05/2025'
    },
    {
      id: 2,
      makeOfICCP: 'Corrosion Control Technologies ICCP-3000',
      dateLastUndocked: '15/06/2025'
    },
    {
      id: 3,
      makeOfICCP: 'Advanced Marine Solutions ICCP-1500',
      dateLastUndocked: '28/07/2025'
    }
  ]);
  ...
  const handleDownload = (id) => {
    console.log('Downloading Hull Potential Return data for ID:', id);
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="bg-white rounded-lg shadow-lg mb-6">
            <div className="bg-[#c7d9f0] text-black px-6 py-4 text-center rounded-t-lg">
              <h5 className="text-2xl font-semibold">HULL POTENTIAL RETURN</h5>
            </div>
                ...
                <table className="w-full border border-gray-300 text-sm">
                  <thead>
                    <tr>
                      ...
                      <TableHeader sortable={true} column="makeOfICCP">Make of ICCP</TableHeader>
                      <TableHeader sortable={true} column="dateLastUndocked">Date Last Undocked</TableHeader>
...
export default HullPotentialReturnReport;
