...
const IN379DockingReportSection3Report = () => {
  ...
  const handleDownload = (id) => {
    console.log('Downloading IN 379 Docking Report Section 3 data for ID:', id);
                ...
                <table className="w-full border border-gray-300 text-sm">
                  <thead>
                    <tr>
                      ...
                      <TableHeader sortable={true} column="workDone">Work Done</TableHeader>
                      <TableHeader sortable={true} column="propellerModification">Propellers Modification</TableHeader>
