...
const IN379DockingReportSection2Report = () => {
  ...
  const handleDownload = (id) => {
    console.log('Downloading IN 379 Docking Report Section 2 data for ID:', id);
                ...
                <table className="w-full border border-gray-300 text-sm">
                  <thead>
                    <tr>
                      ...
                      <TableHeader sortable={true} column="bootTopping">Boot Topping</TableHeader>
                      <TableHeader sortable={true} column="primer">Primer</TableHeader>
