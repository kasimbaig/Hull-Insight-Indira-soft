...
const ICCPReturnsReport = () => {
  ...
  const handleDownload = (id) => {
    console.log('Downloading ICCP Returns data for ID:', id);
                ...
                <table className="w-full border border-gray-300 text-sm">
                  <thead>
                    <tr>
                      ...
                      <TableHeader sortable={true} column="shipLastUndocked">Ship Last Undocked</TableHeader>
                      <TableHeader sortable={true} column="briefDetailsOfPaint">Brief Details of Paint Applied During Last Calibrated Docking</TableHeader>
