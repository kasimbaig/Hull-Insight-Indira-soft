...
const ICCPSystemReport = () => {
  const [tableData, setTableData] = useState([
    ...
    {
      id: 1,
      dateLastDocked: '02/05/2025',
      typeOfReferenceElectrode: 'Silver/Silver Chloride Reference Electrode'
    },
    {
      id: 2,
      dateLastDocked: '13/06/2025',
      typeOfReferenceElectrode: 'Copper/Copper Sulfate Reference Electrode'
    },
    {
      id: 3,
      dateLastDocked: '15/07/2025',
      typeOfReferenceElectrode: 'Zinc Reference Electrode'
    }
  ]);
  ...
  const handleDownload = (id) => {
    console.log('Downloading ICCP System data for ID:', id);
        ...
        <div className="max-w-full mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-lg mb-6">
            <div className="bg-[#c7d9f0] text-black px-6 py-4 text-center rounded-t-lg">
              <h5 className="text-2xl font-semibold">PART-I QUARTERLY HULL POTENTIAL DATA OF SHIPS FITTED WITH ICCP SYSTEM</h5>
            </div>
                ...
                <table className="w-full border border-gray-300 text-sm">
                  <thead>
                    <tr>
                      ...
                      <TableHeader sortable={true} column="dateLastDocked">Date Last Docked</TableHeader>
                      <TableHeader sortable={true} column="typeOfReferenceElectrode">Type of Reference Electrode Used</TableHeader>
...
export default ICCPSystemReport;
